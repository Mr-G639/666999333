...
import { getFinalPrice } from "@/utils/cart"; // Sử dụng hàm tính giá đúng
...
const CartItem: FC<Props> = ({ item }) => {
  ...
  const bind = useDrag(
    ({ last, offset: [ox] }) => {
      ...
      // Chỉ cho phép kéo sang trái (ox < 0)
      if (ox < 0) {
...
// TỐI ƯU HIỆU NĂNG: Chỉ re-render component này khi props (item) thực sự thay đổi.
